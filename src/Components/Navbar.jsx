...
const Navbar = () => {
  ...
  return (
    <div className="w-full navbar bg-[linear-gradient(90deg,#4d9ff5,#0052d4)]  dark:bg-[linear-gradient(90deg,#1e3a8a,#0f172a)] bg-gray-600 shadow-sm md:px-10 px-4">
      ...
      <div className="navbar-end">
        {user ? (
          ...
          <div className="flex gap-3 items-center">
            ...
            <Link
              to={"/login"}
              className="px-6 py-2 bg-white/10 backdrop-blur-md text-white border border-white/20 rounded-lg hover:bg-white/20 transition-all duration-300 h-fit"
            >
              Login
            </Link>
          </div>
